      ...
      <div className="container d-flex align-items-center">
        ...
        <nav id="navbar" className="navbar">
          <ul>
            ...
            <li className="dropdown"><NavLink  style={{color:"white"}}><span>Settings</span> <i className="bi bi-chevron-down"></i></NavLink>
              <ul>
                <li><NavLink to="/about">About</NavLink></li>
                <li><NavLink to="/team">Team</NavLink></li>
                <li><NavLink to="/testimonal">Testimonials</NavLink></li>
  
                <li className="dropdown"><NavLink to="#"><span>Product section</span> <i className="bi bi-chevron-right"></i></NavLink>
                  <ul>
